      ...
      <div className="mx-auto max-w-7xl px-4 py-12">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">Giảm giá 10% cho đơn hàng đầu tiên</p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link to="/profile" className="text-muted-foreground transition-colors hover:text-background">
                  Tài khoản của tôi
                </Link>
              </li>
              <li>
                <Link to="/login" className="text-muted-foreground transition-colors hover:text-background">
                  Đăng nhập/Đăng ký
                </Link>
              </li>
              <li>
                <Link to="/cart" className="text-muted-foreground transition-colors hover:text-background">
                  Giỏ hàng
                </Link>
              </li>
              <li>
                <Link to="/wishlist" className="text-muted-foreground transition-colors hover:text-background">
                  Yêu thích
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/contact" className="text-muted-foreground transition-colors hover:text-background">
                  Liên hệ
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">Tiết kiệm đến 3$ với ứng dụng chỉ dành cho người dùng mới</p>
              ...
              <div className="flex flex-col gap-2">
                ...
                >
                  ...
                  <div className="flex flex-col text-left">
                    <span className="text-[8px] leading-tight text-muted-foreground">GET IT ON</span>
                ...
                >
                  ...
                  <div className="flex flex-col text-left">
                    <span className="text-[8px] leading-tight text-muted-foreground">Download on the</span>
